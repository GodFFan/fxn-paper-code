...
/********************************************************************//**
 *  @~chinese
 *  @brief  设置Bayer格式插值后的Gamma值
 *  @param  handle                      [IN]            设备句柄
 *  @param  fBayerGammaValue            [IN]            Gamma值[0.1,4.0]
 *  @return 成功，返回MV_OK；错误，返回错误码 
 *  @remarks 设置该值后，在调用MV_CC_ConvertPixelType、MV_CC_SaveImageEx2接口将Bayer格式转成RGB24/BGR24/RGBA32/BGRA32时起效。
...
/********************************************************************//**
 *  @~chinese
 *  @brief  设置Bayer格式插值后的色彩校正使能和矩阵
 *  @param  handle                      [IN]            设备句柄
 *  @param  pstCCMParam                 [IN]            色彩校正参数结构体
 *  @return 成功，返回MV_OK；错误，返回错误码 
 *  @remarks 开启色彩校正并设置色彩校正矩阵后，在调用MV_CC_ConvertPixelType、MV_CC_SaveImageEx2接口将Bayer格式转成RGB24/BGR24/RGBA32/BGRA32时起效。
